...
#real_test_filename = 'Testing.txt'
real_test_df_pickle = r'quora_test_final.pkl'
...
if os.path.isfile(real_test_df_pickle):
    ...
    real_test_df = pd.read_csv(real_test_filename, encoding='utf-8',sep="\t")
    real_test_df = real_test_df[['question1', 'question2']]

    print('building word-vec dictionary')
    with open(word_embeddings,encoding='utf-8') as f:
        vec_dictionary = {}
        content = f.readline()
