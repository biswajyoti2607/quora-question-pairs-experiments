...
def train_lstm(
    ...
    input_path = r"Data/FinalDataSet/Training_stripped.tsv"
    input_path_valid = r"Data/FinalDataSet/Validation_stripped.tsv"
    input_path_testing = r"Data/FinalDataSet/Testing_stripped.tsv"

    load_data(input_path, char_dict)
    load_data(input_path_valid, char_dict)
    load_data(input_path_testing, char_dict)
    ...
    train = load_data(input_path, char_dict)
    valid = load_data(input_path_valid, char_dict)
    _, valid = split_at(valid, 0.03)
    test = load_data(input_path_testing, char_dict)
    _, test = split_at(test, 0.03)
